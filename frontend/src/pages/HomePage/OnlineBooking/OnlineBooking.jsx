...
const OnlineBooking = () => {
  ...
  // Thêm các state này sau các state hiện tại
  ...
  // Danh sách bác sĩ (sẽ thay đổi theo cơ sở)
  const doctors = [
  ...
  // Log thông tin (thay bằng API call trong thực tế)
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    {!filteredDoctors.length && bookingData.facility && (
                      <small className="text-muted">Vui lòng chọn cơ sở để xem danh sách bác sĩ</small>
                    )}
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="form-group">
                ...
                <input
                  ...
                  required
                />
                <small className="text-muted">Có thể đặt lịch trong vòng 30 ngày tới</small>
              </div>
            </div>
